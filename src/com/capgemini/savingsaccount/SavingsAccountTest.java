...
public class SavingsAccountTest 
{
	...
	{
		String name =" SavingsAccount [accountBalance=1000.0, accountHolderName=Krishna, accountid=111, isSalary=true] "
				+ "SavingsAccount [accountBalance=5000.0, accountHolderName=Shiva, accountid=112, isSalary=true] "
				+ "SavingsAccount [accountBalance=15000.0, accountHolderName=Ramu, accountid=113, isSalary=true] "
				+ "SavingsAccount [accountBalance=10300.0, accountHolderName=sai, accountid=114, isSalary=true] "
				+ "SavingsAccount [accountBalance=10200.0, accountHolderName=Ganesh, accountid=115, isSalary=true]";
		...
		assertEquals(name,account1.showValues(list));
	}
